...
consumer = KafkaConsumer(
    *['stonks_1y', 'stonks_1mo', 'stonks_5d', 'real_time'],  # List of topics
...
for message in consumer:
    ...
    if message.topic == 'real_time':
        # For real-time data, just send it to Elasticsearch
        es.index(index='real_time', body=raw_data)
    else:
        # For historical data, clean it and convert it to a DataFrame
